...
**Cosa fare:**
1. Sostituire `https://tuosito.com/` con il dominio reale (es. `https://nicolasbrazzo.dev`)
2. Creare un'immagine OG reale `1200×630px` e metterla in `public/og-image.png`
3. Aggiornare `og:image` con l'URL assoluto corretto

```html
<!-- index.html — sostituire questi valori -->
<meta property="og:url" content="https://nicolasbrazzo.dev" />
<meta property="og:image" content="https://nicolasbrazzo.dev/og-image.png" />
<meta name="twitter:image" content="https://nicolasbrazzo.dev/og-image.png" />
```

**Impatto:** Ogni volta che condividi il link, la card social è professionale e invoglia i recruiter a cliccare.

---

### 1.2 Tracciamento analytics

**File:** `index.html`

Al momento non è installato nessun sistema di analytics. Non sai quante persone visitano il portfolio, da dove arrivano, o se leggono fino in fondo.

**Cosa fare (Vercel Analytics — gratuito se già su Vercel):**
...
**In alternativa (Google Analytics 4):**

```html
<!-- index.html — prima di </head> -->
...
**Impatto:** Puoi misurare se le modifiche che fai aumentano il traffico e il tempo sul sito. Senza dati, lavori alla cieca.
