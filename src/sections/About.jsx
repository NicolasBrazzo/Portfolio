    ...
    ScrollTrigger.create({
      ...
      onEnter: () => {
        ...
        tl.to(leftEl,     { opacity: 1, y: 0, duration: 0.65 })
          .to(statsEls,   { opacity: 1, y: 0, duration: 0.50, stagger: 0.10 }, '-=0.35')
          .to(timelineEls,{ opacity: 1, y: 0, duration: 0.55, stagger: 0.12 }, '-=0.30')
      },
      once: true,
    })
  }, { scope: sectionRef })
